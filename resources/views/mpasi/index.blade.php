...
@section('content')
    ...
    <div id="app">
        ...
        <div id="role-portal-pelanggan" class="role-portal-page">
            ...
            <nav class="mobile-bottom-nav d-md-none fixed-bottom py-1 px-2">
                <div class="d-flex justify-content-around align-items-center h-100">
                    ...
                    <a href="#" class="mobile-nav-item d-flex flex-column align-items-center text-decoration-none py-1 px-1 rounded-3" id="mobile-nav-login" onclick="switchCustView(state.currentUser ? 'poin' : 'login')">
    ...
    <script>
        ...
        function showEditCustomerProfileModal() {
            if (!state.currentUser) { switchCustView('login'); return; }
